        ...
        <View style={{ alignItems: "center" }}>
          <TouchableOpacity onPress={() => action()}>
            <Svg viewBox="0 0 80 160" width="40" height="80">
              <Svg.Circle cx="40" cy="80" r="40" fill="#4e4e4e" />
              <Svg.Ellipse cx="40.5" cy="81" rx="28.5" ry="29" fill="#303030" />
              <Svg.Circle cx="40" cy="80" r="28" fill="#999" />
              <Svg.Circle cx="40" cy="80" r="8" fill="#5e5e5e" />
              <Svg.Ellipse
                cx="40.165"
                cy="80.159"
                rx="7.835"
